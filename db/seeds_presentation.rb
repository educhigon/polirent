...
image_urls = {
  ...
  angela_merkel: {
    p: "https://ygo-assets-entities-us.yougov.net/ef0b5614-b0b7-11e6-adde-09142178952f.jpg?pw=140"
  },
  barack_obama: {
    p: "https://ygo-assets-entities-us.yougov.net/516e6836-d278-11ea-a709-979a0378f022.jpg?pw=7000"
  },
  dick_cheney: {
    p: "https://ygo-assets-entities-us.yougov.net/1e08e514-2d03-11e6-9570-cf1c514d3e57.jpg?pw=7000"
  },
  donald_trump: {
...
descriptions = {
  ...
  angela_merkel: "Angela Dorothea Merkel German: [aŋˈɡeːla doʁoˈteːa ˈmɛʁkl̩] ⓘ ; née Kasner ; born 17 July 1954) is a German retired politician and chemist who served as Chancellor of Germany from 2005 to 2021 and was the first woman to hold that office. She previously served as Leader of the Opposition from 2002 to 2005 and as Leader of the Christian Democratic Union from 2000 to 2018. During her chancellorship, Merkel was frequently referred to as the de facto leader of the European Union (EU) and the most powerful woman in the world. Beginning in 2016, she was often described as the leader of the free world.",
  barack_obama: "Barack Hussein Obama II [a] (born August 4, 1961) is an American politician who served as the 44th president of the United States from 2009 to 2017. A member of the Democratic Party, he was the first African-American president in United States history. Obama previously served as a U.S. senator representing Illinois from 2005 to 2008, as an Illinois state senator from 1997 to 2004, and as a community service organizer, civil rights lawyer, and university lecturer.",
  ...
  shinzo_abe: "Shinzo Abe ( /ˈʃɪnzoʊ ˈɑːbeɪ/ SHIN-zoh AH-bay ; Japanese : 安倍 晋三 , Hepburn : Abe Shinzō , [abe ɕindzoː] ; 21 September 1954 – 8 July 2022) was a Japanese politician and statesman who served as Prime Minister of Japan and President of the Liberal Democratic Party (LDP) from 2006 to 2007 and again from 2012 to 2020. He was the longest-serving prime minister in Japanese history, serving for almost nine years in total. Abe also served as Chief Cabinet Secretary from 2005 to 2006 under Junichiro Koizumi and was briefly the opposition leader in 2012.",
  jair_bolsonaro: "Jair Messias Bolsonaro Brazilian Portuguese: [ʒaˈiʁ meˈsi.ɐz bowsoˈnaɾu] ; born 21 March 1955) is a Brazilian politician and retired military officer who served as the 38th president of Brazil from 2019 to 2023. He previously served as member of Brazil's Chamber of Deputies from 1991 to 2018.",
  mohammed_bin_salman: "Mohammed bin Salman Al Saud ( Arabic : محمد بن سلمان آل سعود , romanized: Muḥammad bin Salmān ʾĀl Su‘ūd ; born 31 August 1985) is the de facto ruler of Saudi Arabia. The heir apparent to the Saudi Arabian throne, he is currently Crown Prince and Prime Minister. He is the seventh son of King Salman of Saudi Arabia and grandson of the nation's founder, King Abdulaziz.",
...
politicians_data = [
  { name: 'Angela Merkel', **additional_values[:angela_merkel], description: descriptions[:angela_merkel], image_url: image_urls[:angela_merkel][:p] },
  { name: 'Barack Obama', **additional_values[:barack_obama], description: descriptions[:barack_obama], image_url: image_urls[:barack_obama][:p] },
  { name: 'Dick Cheney', **additional_values[:dick_cheney], description: descriptions[:dick_cheney], image_url: image_urls[:dick_cheney][:p] },
  { name: 'Donald Trump', **additional_values[:donald_trump], description: descriptions[:donald_trump], image_url: image_urls[:donald_trump][:p] },
  { name: 'Xi Jinping', **additional_values[:xi_jinping], description: descriptions[:xi_jinping], image_url: image_urls[:xi_jinping][:p] },
  { name: 'Shinzo Abe', **additional_values[:shinzo_abe], description: descriptions[:shinzo_abe], image_url: image_urls[:shinzo_abe][:p] },
  { name: 'Jair Bolsonaro', **additional_values[:jair_bolsonaro], description: descriptions[:jair_bolsonaro], image_url: image_urls[:jair_bolsonaro][:p] },
  { name: 'Mohammed bin Salman', **additional_values[:mohammed_bin_salman], description: descriptions[:mohammed_bin_salman], image_url: image_urls[:mohammed_bin_salman][:p] },
  { name: 'Bernie Sanders', **additional_values[:bernie_sanders], description: descriptions[:bernie_sanders], image_url: image_urls[:bernie_sanders][:p] },
  { name: 'Alexander the Great', **additional_values[:alexander_the_great], description: descriptions[:alexander_the_great], image_url: image_urls[:alexander_the_great][:p] },
  { name: 'Cleopatra', **additional_values[:cleopatra], description: descriptions[:cleopatra], image_url: image_urls[:cleopatra][:p] },
  { name: 'Voldemort', **additional_values[:voldemort], description: descriptions[:voldemort], image_url: image_urls[:voldemort][:p] },
  { name: 'Napoleon', **additional_values[:napoleon], description: descriptions[:napoleon], image_url: image_urls[:napoleon_img][:p] }
]
...
users.each do |user|
  3.times do
    Booking.create!(politician_id: politicians.sample.id, user_id: user.id, status: 0)
  end
end
