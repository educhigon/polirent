...
politicians_data = [
  { name: 'Angela Merkel', tag: tags.sample, **additional_values[:angela_merkel], description: descriptions[:angela_merkel], image_url: image_urls[:angela_merkel][:p] },
  { name: 'Barack Obama', tag: tags.sample, **additional_values[:barack_obama], description: descriptions[:barack_obama], image_url: image_urls[:barack_obama][:p] },
  { name: 'Dick Cheney', tag: tags.sample, **additional_values[:dick_cheney], description: descriptions[:dick_cheney], image_url: image_urls[:dick_cheney][:p] },
  { name: 'Donald Trump', tag: tags.sample, **additional_values[:donald_trump], description: descriptions[:donald_trump], image_url: image_urls[:donald_trump][:p] },
  { name: 'Xi Jinping', tag: tags.sample, **additional_values[:xi_jinping], description: descriptions[:xi_jinping], image_url: image_urls[:xi_jinping][:p] },
  { name: 'Shinzo Abe', tag: tags.sample, **additional_values[:shinzo_abe], description: descriptions[:shinzo_abe], image_url: image_urls[:shinzo_abe][:p] },
  { name: 'Jair Bolsonaro', tag: tags.sample, **additional_values[:jair_bolsonaro], description: descriptions[:jair_bolsonaro], image_url: image_urls[:jair_bolsonaro][:p] },
  { name: 'Mohammed bin Salman', tag: tags.sample, **additional_values[:mohammed_bin_salman], description: descriptions[:mohammed_bin_salman], image_url: image_urls[:mohammed_bin_salman][:p] },
  { name: 'Bernie Sanders', tag: tags.sample, **additional_values[:bernie_sanders], description: descriptions[:bernie_sanders], image_url: image_urls[:bernie_sanders][:p] },
  { name: 'Alexander the Great', tag: tags.sample, **additional_values[:alexander_the_great], description: descriptions[:alexander_the_great], image_url: image_urls[:alexander_the_great][:p] },
  { name: 'Cleopatra', tag: tags.sample, **additional_values[:cleopatra], description: descriptions[:cleopatra], image_url: image_urls[:cleopatra][:p] },
  { name: 'Voldemort', tag: tags.sample, **additional_values[:voldemort], description: descriptions[:voldemort], image_url: image_urls[:voldemort][:p] },
  { name: 'Napoleon', tag: tags.sample, **additional_values[:napoleon], description: descriptions[:napoleon], image_url: image_urls[:napoleon_img][:p] }
]
